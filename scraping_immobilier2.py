...
def scrape_property_details(page_url):
    ...
    for listing in listings:
        ...
        try:
            ...
            if "consulter" in price.lower() or "Price not listed" in price.lower():
                price = "100 000 TND"
...
def save_to_excel(properties, file_name="properties2.xlsx"):
...
page_url = "https://www.mubawab.tn/fr/cc/immobilier-a-vendre-all:p:2"
